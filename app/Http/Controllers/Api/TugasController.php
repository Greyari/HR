...
class TugasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            'indonesia' => [
                ...
                'nama_lokasi_penugasan.max'         => 'Nama lokasi tidak boleh lebih dari 255 karakter.',
            ],
            'inggris' => [
                ...
                'nama_lokasi_penugasan.max'         => 'Location name must not exceed 255 characters.',
            ],
        ];
        ...
        $validated = $request->validate([
            ...
            'nama_lokasi_penugasan'  => 'nullable|string|max:255',
    ...
    public function uploadLampiran(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'lampiran_lat' => 'nullable|numeric',
            'lampiran_lng' => 'nullable|numeric',
        ], $messages[$bahasa]);
        ...
        if ($request->filled('lampiran_lng')) {
